...
console.log(data.image);
    ...
    $('#profile-picture-form').on('submit',function(e){
        ...
        $.ajax({
            ...
            $('#profile-picture').attr('src',data.path);
        });
